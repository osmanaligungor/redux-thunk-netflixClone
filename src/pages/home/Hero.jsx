...
const Hero = () => {
  ...
  // popular filmler için api isteğinde bulunduk
  useEffect(() => {
    api
      .get("/movie/popular")
      .then((res) => {
        ...
        // 0-1 arasında rasgele sayı üret / movie dizisi uzunluğunda çarp ki rasgele movie al
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 md:max-h-[400px] gap-5 mb-10">
      ...
      <div>
        <img
          className="drop-shadow-[0_0_80px_rgba(255,255,255,0.5)] my-4 object-contain rounded max-h-[300px]"
